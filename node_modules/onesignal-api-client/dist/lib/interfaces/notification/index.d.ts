 ...
 * @extends {IPlatform}
 */
export interface INotificationSegments extends ISegments, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
    /**
 ...
 * @extends {IPlatform}
 */
export interface INotificationFilters extends IFilters, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
    /**
     * An array of OneSignal app IDs. All users within these apps will receive at most one notification.
     * No targeting parameters may be used when using the `app_ids` parameter. All subscribed users will receive the notification.
     *
 ...
 * @extends {IPlatform}
 */
export interface INotificationDevices extends IDevices, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
    /**
     * An array of OneSignal app IDs. All users within these apps will receive at most one notification.
     * No targeting parameters may be used when using the `app_ids` parameter. All subscribed users will receive the notification.
     *
 ...
 * @extends {IPlatform}
 */
export interface INotificationSegmentsStrict extends ICommon, ISegments, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
}
/**
 * Notification for filters
 *
 ...
 * @extends {IPlatform}
 */
export interface INotificationFiltersStrict extends ICommon, IFilters, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
}
/**
 * Notification for devices.
 *
 ...
 * @extends {IPlatform}
 */
export interface INotificationDevicesStrict extends ICommon, IDevices, IContent, IAttachments, IActionButtons, IAppearance, IDelivery, IGroup, IPlatform {
}
